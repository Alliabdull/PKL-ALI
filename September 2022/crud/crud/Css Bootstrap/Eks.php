...
<body id="home">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-2">
                <a href="Ekstrakurikuler/Create.php" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-plus"></span> <b>Tambah</b></a>
            </div>
            ...
            <div class="col-sm-12">
                <div class="marg-top panel panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title"><b>Data Ekstrakurikuler</b></h3>
                    </div>
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td style="text-align: center;">
                                                <a onclick="return confirm('Apakah yakin data akan di hapus?')" href="Ekstrakurikuler/delete.php?Id=<?php echo $obj->Id; ?>" class="btn btn-danger btn-sm"><span class="glyphicon glyphicon-trash"></span></a>
                                                <a href="Ekstrakurikuler/update.php?Id=<?php echo $obj->Id; ?>" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-edit"></span>>Edit</a>
